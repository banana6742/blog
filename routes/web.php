...
//one-one relationship user->openssl_pkey_export_to_file
Route::get('/test/profile',function(){
    return App\User::find(7)->profile;
});
Route::get('/test/user',function(){
    return App\Profile::find(3)->user;
});
...
Route::group(['middleware' => 'auth'], function(){
    ...
    //many-many relationship posts->get_meta_tags
